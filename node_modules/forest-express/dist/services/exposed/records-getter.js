...
var RecordsGetter =
/*#__PURE__*/
function (_AbstractRecordServic) {
  ...
  function RecordsGetter() {
    ...
    return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(RecordsGetter).apply(this, arguments));
  }
  ...
  (0, _createClass2["default"])(RecordsGetter, [{
    ...
    value: function () {
      var _getIdsFromRequest = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
              ...
              case 0:
                ...
                function () {
                  ...
                  _regenerator["default"].mark(function _callee(attributes) {
                    var parentCollectionId, parentCollectionName, parentAssociationName, parentModel, _ref4, _ref5, records;
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            ...
                            _context.next = 5;
                            return new _this2.Implementation.HasManyGetter(parentModel, _this2.model, _this2.lianaOptions, _objectSpread({}, params, {}, attributes.allRecordsSubsetQuery, {
                          ...
                          case 9:
                            return _context.abrupt("return", _this2.getAll(_objectSpread({}, attributes.allRecordsSubsetQuery, {
                              page: attributes.page
                            })));
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            ...
                            parentModel = _this2.Implementation.getModels()[parentCollectionName];
                            return _context2.abrupt("return", new _this2.Implementation.HasManyGetter(parentModel, _this2.model, _this2.lianaOptions, _objectSpread({}, params, {
                              recordId: parentCollectionId,
                              associationName: parentAssociationName
                            })).count());
